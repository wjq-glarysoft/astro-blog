...
tasklist and taskkill View all running processes (tasklist) and end a specific task (taskkill /PID \[pid_number\]). This is helpful when dealing with unresponsive applications.
