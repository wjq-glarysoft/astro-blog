...
Get-CimInstance -ClassName Win32_StartupCommand | Select-Object Name, Command, User | Out-GridView
...
1\. Open Registry Editor (regedit). 2. Navigate to: - HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run - HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run 3. Safely delete entries for obsolete or unwanted applications.
