...
1\. Press Windows Key + R, type regedit, and press Enter. 2. Navigate to the relevant key (e.g., HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters). 3. Right-click the folder/key, select "Export," and save as a .reg file.
