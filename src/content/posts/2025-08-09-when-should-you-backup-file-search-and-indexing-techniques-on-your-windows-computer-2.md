...
1\. Press Win + R, type regedit, and press Enter. 2. Navigate to HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows Search. 3. Right-click the Windows Search key and select Export. 4. Save the .reg file to a safe location or your backup drive.
