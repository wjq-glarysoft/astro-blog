...
\- Open Registry Editor (regedit). - Navigate to HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Multimedia\\SystemProfile. - Find NetworkThrottlingIndex, and set its value to FFFFFFFF (hexadecimal) to disable throttling. Restart required.
