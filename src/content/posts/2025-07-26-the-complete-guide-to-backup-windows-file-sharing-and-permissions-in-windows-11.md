...
1\. Press Win + R, type regedit, and press Enter. 2. Navigate to: HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\LanmanServer\\Shares 3. Right-click Shares, select Export, and save the \`.reg\` file somewhere safe.
