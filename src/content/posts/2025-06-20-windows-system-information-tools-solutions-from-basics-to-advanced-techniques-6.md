...
2\. PowerShell For detailed, customizable queries: - To get processor info, type: Get-WmiObject Win32_Processor - For memory modules: Get-WmiObject Win32_PhysicalMemory
