...
\- Open Registry Editor (press Win + R, type regedit, press Enter). - Navigate to: HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows Search and HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Explorer\\FolderTypes - Right-click the relevant key, select “Export,” and save the file as a backup.
