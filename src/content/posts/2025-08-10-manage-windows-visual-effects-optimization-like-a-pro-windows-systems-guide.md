...
Registry method (for advanced use and automation): 1. Export your preferred settings from HKEY_CURRENT_USER\\Software\\Microsoft\\Windows\\CurrentVersion\\Explorer\\VisualEffects 2. Apply with a batch or PowerShell script across user profiles or via Group Policy Preferences.
