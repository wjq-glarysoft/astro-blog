...
\- Press Win+R, type "regedit," and press Enter. - For example, to add custom entries to the right-click context menu in File Explorer, navigate to HKEY_CLASSES_ROOT\\Directory\\Background\\shell and create new keys.
