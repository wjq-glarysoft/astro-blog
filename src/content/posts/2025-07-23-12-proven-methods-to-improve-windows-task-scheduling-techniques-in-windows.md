...
Protect your system by scheduling regular restore points. In Task Scheduler, create a new task that runs the following command: \`powershell.exe -Command "Checkpoint-Computer -Description 'Scheduled Restore Point' -RestorePointType 'MODIFY_SETTINGS'"\`
