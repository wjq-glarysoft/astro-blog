...
1\. Open Registry Editor (regedit). 2. Navigate to your modified keys (e.g., \`HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\Lsa\`). 3. Right-click the key, select Export, and save the .reg file in your backup.
