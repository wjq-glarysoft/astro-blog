...
\- Cleanup_Registry - Malware_Scan - Disk_Check_Repair - Backup_Recovery - Monitoring_Logs

Use clear, consistent naming for executable files and documentation—include tool versions in filenames for easy reference (e.g., "GlaryUtilities6.0_Portable.exe").
...
@echo off echo Running System Cleanup... start "" "C:\\Tools\\GlaryUtilities6.0_Portable.exe" /AUTOCLEAN sfc /scannow pause
...
\- Boot from USB containing your portable repair toolkit - Use Glary Utilities Portable for registry and shortcut repairs - Run chkdsk and other disk repair tools from your "Disk_Check_Repair" folder - Restore the system from a backup in your "Backup_Recovery" folder if needed
