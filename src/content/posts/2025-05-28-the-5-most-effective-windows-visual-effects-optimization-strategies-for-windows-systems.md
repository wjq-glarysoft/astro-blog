...
1\. Press Windows + R, type regedit, and press Enter. 2. Navigate to HKEY_CURRENT_USER\\Software\\Microsoft\\Windows\\CurrentVersion\\Themes\\Personalize. 3. Set the value of EnableTransparency to 0. 4. Log off and back in to apply the change.
