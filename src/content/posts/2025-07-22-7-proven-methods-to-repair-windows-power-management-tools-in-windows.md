...
1\. Open regedit. 2. Navigate to HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\Power 3. Edit or add DWORD values such as CsEnabled (set to 0 to expose all sleep states).
