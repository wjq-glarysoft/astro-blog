...
For example, to back up UAC settings: 1. Press Windows+R, type regedit, and press Enter. 2. Navigate to HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Policies. 3. Right-click 'System', select Export, and save the .reg file.
