...
1\. Use Built-in Tools for Basic Inventory List installed apps via Settings > Apps or using PowerShell with \`Get-WmiObject -Class Win32_Product | Select-Object Name, Version\`
