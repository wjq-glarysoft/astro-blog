...
Systeminfo Command Run Command Prompt as an administrator, then type: systeminfo > C:\\system_report.txt This creates a comprehensive report with OS details, hotfixes, network adapters, and more.
