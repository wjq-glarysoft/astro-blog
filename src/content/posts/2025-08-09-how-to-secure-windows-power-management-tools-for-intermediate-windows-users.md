...
\- List all available power settings: powercfg /query - See devices allowed to wake the computer: powercfg /devicequery wake_armed - Prevent devices from waking the computer: powercfg /devicedisablewake "Device Name"
