...
How to: a. Open Registry Editor (Win + R, type “regedit”). b. Navigate to: HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run and HKEY_CURRENT_USER\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Run c. Right-click each "Run" key and select "Export" to save as REG files.
