...
1\. Press Windows + R, type regedit, and press Enter. 2. Navigate to HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows\\DataCollection. 3. Modify or create the DWORD “AllowTelemetry” and set to 0 for maximum privacy.
