...
Core Parking is a Windows feature that disables CPU cores to save power, but can reduce performance. Open Command Prompt as Administrator. Enter: powercfg -attributes SUB_PROCESSOR CPMINCORES -ATTRIB_HIDE Now, in Power Options > Change advanced power settings, you’ll see “Processor performance core parking min cores”—set this to 100% to keep all cores active.
