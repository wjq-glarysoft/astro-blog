...
Run PowerShell and use commands like: Get-WmiObject -Class Win32_ComputerSystem | Export-Csv -Path C:\\Backup\\system_details.csv
...
From Command Prompt, type: sc query state= all > C:\\Backup\\services_list.txt
