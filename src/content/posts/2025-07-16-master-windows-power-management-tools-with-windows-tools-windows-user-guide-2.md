...
Advanced troubleshooting: Use powercfg /requests to identify active processes or devices preventing sleep. Use powercfg /devicequery wake_armed to list devices allowed to wake your system—vital for preventing unwanted wake events.
