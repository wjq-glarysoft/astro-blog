...
\- Ensuring the existence and correct permissions of the HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\WindowsUpdate - Deleting or resetting SUSClientId and PingID for WSUS clients (if domain-joined)
