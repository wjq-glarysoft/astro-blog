...
\- Open the Registry Editor (regedit) and inspect keys at: HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows\\WindowsUpdate - Remove or adjust keys that force update deferrals or point to an incorrect WSUS server. - Backup the registry before any changes.
