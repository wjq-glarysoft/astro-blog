...
Example: Before editing “HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\Session Manager\\Memory Management”, export the key. If a tweak causes boot issues, double-click the .reg file to restore.
