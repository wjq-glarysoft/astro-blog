...
1\. Open the Registry Editor (press Win + R, type \`regedit\`, and press Enter). 2. Navigate to the key you’ve modified—commonly found under: HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters 3. Right-click the "Parameters" folder and select "Export." 4. Save the .reg file somewhere safe. Name it descriptively, such as “TCPIP_Params_Backup.reg.”
