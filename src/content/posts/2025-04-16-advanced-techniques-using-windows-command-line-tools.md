...
Example: Open the Command Prompt and type: systeminfo This command will display a thorough report of your system's specifications. You can also export this data to a text file for further analysis: systeminfo > C:\\system_info.txt
