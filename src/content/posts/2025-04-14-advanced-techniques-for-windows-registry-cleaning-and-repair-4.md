...
\- Open Command Prompt as an administrator. - Use commands like reg add, reg delete, or reg query to make changes. For example, to add a key: reg add HKLM\\Software\\YourSoftware /v YourValueName /t REG_SZ /d YourData
