...
1\. Press Windows + R, type "regedit", and press Enter. 2. Navigate to: HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Control\\Power 3. Right-click the ‘Power’ key and select Export. 4. Save the .reg file as a backup.
