...
\- To get system info, open Command Prompt and type: systeminfo - For hardware details using PowerShell: Get-ComputerInfo Or target specifics, like memory: Get-WmiObject Win32_PhysicalMemory
