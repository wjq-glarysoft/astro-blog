...
Example: To display battery status (on laptops): wmic path Win32_Battery get EstimatedChargeRemaining
...
Example commands: - Generate a battery report: powercfg /batteryreport /output "C:\\battery_report.html" - List available power schemes: powercfg /list
