...
\- To generate a detailed report on battery health: powercfg /batteryreport /output "C:\\battery_report.html"

\- To view available power schemes: powercfg /list

\- To set the high performance scheme: powercfg /setactive SCHEME_MIN
