...
For example: 2024-06-15_ClientABC_Proposal_v2_TJ.docx
...
\- snake_case: efficient for scripts (project_report_final.docx) - PascalCase or CamelCase: readable, common for programming (ProjectReportFinal.docx) - Lowercase with dashes: great for web use (project-report-final.docx)
