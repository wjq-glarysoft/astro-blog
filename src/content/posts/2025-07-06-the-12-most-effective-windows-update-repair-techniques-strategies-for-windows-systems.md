...
1\. Run gpedit.msc and check Computer Configuration > Administrative Templates > Windows Components > Windows Update. 2. Set relevant policies to “Not Configured” if unsure. 3. For registry, open regedit and verify values under HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows\\WindowsUpdate 4. Delete or correct misapplied settings.
