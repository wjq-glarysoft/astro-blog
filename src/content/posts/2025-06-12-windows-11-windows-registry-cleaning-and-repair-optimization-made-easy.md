...
Practical Example: Editing HKEY_LOCAL_MACHINE settings for a 32-bit app under the assumption the changes will take effect, while the real key is under Wow6432Node.
