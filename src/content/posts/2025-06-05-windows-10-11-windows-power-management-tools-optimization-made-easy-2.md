...
\- Set the active power scheme: powercfg /S SCHEME_GUID

\- Prevent sleep for specific hardware events or apps: powercfg /devicequery wake_armed
...
1\. Launch Task Scheduler (taskschd.msc). 2. Create a new task triggered by events—like plugging in AC power, launching specific apps, or certain times of day. 3. Use the "Start a program" action with powercfg to switch plans: powercfg /S SCHEME_GUID
