...
\- powercfg /devicequery wake_armed to list devices allowed to wake the PC. - Device Manager to disable “Allow this device to wake the computer” on unnecessary hardware (for example, network adapters).
