...
Alternatively, use the Registry Editor: - Press Win + R, type regedit, and press Enter - Navigate to HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows\\DataCollection - Set the DWORD value “AllowTelemetry” to 0.
