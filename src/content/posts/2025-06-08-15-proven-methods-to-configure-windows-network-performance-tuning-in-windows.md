...
Steps: - Press Windows + R, type regedit, and press Enter. - Navigate to HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters - Add or adjust these DWORD values: TcpAckFrequency = 1 (lowers latency for gaming) TCPNoDelay = 1 (enables Nagle’s Algorithm) - Restart your PC.
