...
Example: Suppose an old driver causes startup errors. Find its registry references in HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\, export the key, then delete it.
