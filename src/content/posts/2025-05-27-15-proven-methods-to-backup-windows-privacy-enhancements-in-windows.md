...
How to export a key: - Press Win+R, type “regedit”, and press Enter. - Find the key you modified (e.g., HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows\\). - Right-click the key > Export > Save as .reg file.
