...
Run systeminfo and tasklist to quickly audit system specs and running processes. Redirect output to files for documentation or further analysis: systeminfo > D:\\Audit\\sys_report.txt.
