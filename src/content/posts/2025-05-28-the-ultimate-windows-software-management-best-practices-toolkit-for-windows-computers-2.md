...
2\. Generate a List with PowerShell: - Right-click the Start button, select Windows Terminal (Admin). - Type: Get-WmiObject -Class Win32_Product | Select-Object Name > C:\\InstalledPrograms.txt - This creates a text file listing all installed programs at C:\\InstalledPrograms.txt.
