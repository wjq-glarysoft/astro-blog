...
Fix Broken File Associations - File associations are stored under HKEY_CLASSES_ROOT. - If certain files aren’t opening correctly, check their association keys and correct the “(Default)” value as needed.
