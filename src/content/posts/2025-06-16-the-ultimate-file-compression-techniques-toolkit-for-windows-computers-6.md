...
cd C:\\Logs "C:\\Program Files\\7-Zip\\7z.exe" a -t7z logs_backup.7z \*.log

2\. Save the file as backup_logs.bat. 3. Schedule the script with Windows Task Scheduler for automated execution.
