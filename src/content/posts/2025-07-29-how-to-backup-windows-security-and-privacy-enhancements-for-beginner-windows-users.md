...
Export Registry Keys: - Open Registry Editor (Windows + R > type “regedit”). - Navigate to the key you changed (for example, HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows). - Right-click the key, select “Export,” and save the .reg file somewhere safe.
