...
2\. Backup Registry Settings - Press Win + R, type 'regedit', and hit Enter to open the Registry Editor. - Navigate to 'HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services', or any specific path you wish to backup. - Right-click the key and select 'Export'. Save the .reg file to your backup location.
