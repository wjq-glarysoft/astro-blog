...
\- Open regedit and navigate to HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows\\DataCollection. - Create (or edit) DWORD value "AllowTelemetry" and set it to 0.
