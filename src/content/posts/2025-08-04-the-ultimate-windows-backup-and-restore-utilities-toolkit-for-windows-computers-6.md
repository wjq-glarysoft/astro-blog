...
\- Redirect File History to a network location or encrypted drive - Increase backup frequency by editing registry values (e.g., HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\fhsvc\\Parameters) - Use symlinks or junction points to include custom folders outside default libraries
