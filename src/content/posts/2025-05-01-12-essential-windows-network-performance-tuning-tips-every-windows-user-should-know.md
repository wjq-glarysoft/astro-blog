...
\- Open the registry editor via Win + R, type 'regedit', and press Enter. - Navigate to HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\Tcpip\\Parameters\\Interfaces. - Find your network interface, create a new DWORD (32-bit) Value named ‘TcpAckFrequency’ and set it to 1.
