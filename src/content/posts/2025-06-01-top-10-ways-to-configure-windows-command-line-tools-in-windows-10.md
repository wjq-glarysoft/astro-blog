...
PowerShell is a more advanced tool that allows scripting. For example, you can list all installed programs by typing: Get-WmiObject -Class Win32_Product Save this command as a script to run it whenever you want an updated list.
