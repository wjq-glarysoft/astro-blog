...
Steps: - Press Windows + R, type regedit, and press Enter. - Navigate to HKEY_LOCAL_MACHINE\\SOFTWARE\\Microsoft\\Windows NT\\CurrentVersion\\Multimedia\\SystemProfile. - Find or create a DWORD value named NetworkThrottlingIndex and set its value to FFFFFFFF (hexadecimal) to disable throttling. - Restart your computer.
