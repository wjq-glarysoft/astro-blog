...
1\. Press Windows+R, type regedit, and press Enter. 2. Navigate to HKEY_USERS\\.DEFAULT\\Control Panel\\Desktop. 3. Find or create the string value AutoEndTasks and set its value to 1.
