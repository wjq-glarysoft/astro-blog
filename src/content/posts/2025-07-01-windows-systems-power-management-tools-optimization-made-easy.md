...
Examples: - List all available power schemes: powercfg /list - Switch to High Performance plan: powercfg /setactive SCHEME_MIN - Generate a detailed power efficiency report: powercfg /energy
