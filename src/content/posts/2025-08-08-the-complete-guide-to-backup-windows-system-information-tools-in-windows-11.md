...
1\. Press Windows+R, type msinfo32, and press Enter. 2. In the System Information window, select File > Export. 3. Choose a directory (preferably a dedicated backup folder on an external drive or network location). 4. Save the file with a date-specific name (e.g., SysInfo_2024-06-21.txt). 5. Schedule this task monthly to maintain up-to-date records.
...
Get-WmiObject -Class Win32_Product | Select-Object Name, Version | Export-Csv "D:\\Backups\\InstalledApps\_$(Get-Date -Format yyyyMMdd).csv" -NoTypeInformation
...
\- Open Command Prompt as Administrator. - Run: driverquery /FO CSV /V > D:\\Backups\\Drivers_20240621.csv
