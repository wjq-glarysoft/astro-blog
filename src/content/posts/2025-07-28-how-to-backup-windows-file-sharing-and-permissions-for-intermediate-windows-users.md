...
To Export Share Definitions: 1. Press Win+R, type \`regedit\`, and press Enter. 2. Navigate to HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\LanmanServer\\Shares 3. Right-click on the 'Shares' key and select Export. 4. Save the .reg file to your backup location.
...
To backup permissions: icacls "C:\\SharedFolder" /save "D:\\Backup\\SharedFolder_perms.txt" /T

To restore permissions: icacls "C:\\SharedFolder" /restore "D:\\Backup\\SharedFolder_perms.txt"
